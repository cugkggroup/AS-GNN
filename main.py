    ...
    for dataset_name in datasets_name:
        ...
        for repeat in range(args.repeat_num):
            ...
            for i,data in enumerate(data_list):
                preselect_anchor(data, layer_num=args.layer_num, anchor_num=args.anchor_num, filename=args.dataset, subgraph_id=data.num_nodes, device='cpu')
                data = data.to(device)
                data_list[i] = data
            ...
            for epoch in range(args.epoch_num):
                ...
                for id, data in enumerate(data_list[:effective_len]):
                    if args.permute:
                        preselect_anchor(data, layer_num=args.layer_num, anchor_num=args.anchor_num, filename=args.dataset, subgraph_id=data.num_nodes, device=device)
                    out = model(data)
        ...
        print('-----------------Final-------------------',args.dataset,args.task,args.approximate)
